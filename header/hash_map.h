...
#include <math.h> 	/* sqtr */ /* type -lm when compileing */
...
typedef int	(*ItemActionFunction)(void* _elemnt, void* _context);
typedef void	(*SimpleFunc)(void* _elemnt);
