...
/*
//	This is implamintion of ITR.
//
//	Yuval Hamberg Mar 2017
// 	yuval.hamberg@gmail.com
*/

/* 	Note this Itr works on data stracture with sentinal.
*	Choosing the end command with set the itr on the end sentinal.
*	The user can't remove, set or get the sential and would recive NULL or no action depanding on comand.
*	The user cann't reach the start sentinal.
*/
 ...
 * @return NULL if error beacouse list is NULL or destroyed.
 */
 ...
 * @return FALSE if error beacouse list is NULL or destroyed.
 */
 ...
 * @return NULL if error beacouse list is NULL or destroyed. also if trying to set the end sentinal.
 */
 ...
 * If pointing at end sentinal, do nothing and return NULL --yuval.
 */
