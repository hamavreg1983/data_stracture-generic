...
/*
//	This is implamintion of functions on top of ITR.
//
 ...
 * if one of the pointer is null, NULL is returnd. --yuval
 * normally return the ListItr pointer to _end. --yuval
 */
 ...
 * O(n)
 *
 * a new list is created and returned. user is responibul to free it at the end.
 */
